...
export const employeeService = {
  ...
  create: (pharmacyId, data) => api("POST", `/api/v1/pharmacist/pharmacies/${pharmacyId}/staff`, { body: data }),
  update: (pharmacyId, staffId, data) => api("PUT", `/api/v1/pharmacist/pharmacies/${pharmacyId}/staff/${staffId}`, { body: data }),
  remove: (pharmacyId, staffId) => api("DELETE", `/api/v1/pharmacist/pharmacies/${pharmacyId}/staff/${staffId}`),
